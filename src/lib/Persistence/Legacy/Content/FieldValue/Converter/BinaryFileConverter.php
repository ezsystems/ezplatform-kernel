...
class BinaryFileConverter implements Converter
{
     ...
     *
     * @return \Ibexa\Core\Persistence\Legacy\Content\FieldValue\Converter\BinaryFileConverter
     */
...
class_alias(BinaryFileConverter::class, 'eZ\Publish\Core\Persistence\Legacy\Content\FieldValue\Converter\BinaryFileConverter');
