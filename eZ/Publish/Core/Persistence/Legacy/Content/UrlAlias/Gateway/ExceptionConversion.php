...
final class ExceptionConversion extends Gateway
{
    ...
    {
        try {
            $this->innerGateway->updateRow($parentId, $textMD5, $values, $languageId);
        } catch (DBALException | PDOException $e) {
            throw DatabaseException::wrap($e);
        }
    }
    ...
    {
        try {
            return $this->innerGateway->loadRow($parentId, $textMD5, $languageId);
        } catch (DBALException | PDOException $e) {
            throw DatabaseException::wrap($e);
        }
    }
    ...
    {
        try {
            return $this->innerGateway->loadAutogeneratedEntry($action, $parentId, $languageId);
        } catch (DBALException | PDOException $e) {
            throw DatabaseException::wrap($e);
        }
    }
