...
abstract class Gateway
{
     ...
     */
    abstract public function updateRow(int $parentId, string $textMD5, array $values, ?int $languageId = null): void;
     ...
     */
    abstract public function loadRow(int $parentId, string $textMD5, ?int $languageId = null): array;
     ...
     */
    abstract public function loadAutogeneratedEntry(string $action, ?int $parentId = null, ?int $languageId = null): array;
